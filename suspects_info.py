...
class SuspectsInfo:
    ...
    def generate_suspects_report_random():
        ...
        suspect_names = case_data['selected suspects']
        
        # sets each of the derived values into its own variable to use in the first generate method, and save the data
        selected_hair_colors = SuspectsInfo.get_hair_color(SuspectsInfo.suspect_hair_color_list, 5)
        selected_height_types = SuspectsInfo.get_height_type(SuspectsInfo.suspect_height_type_list, 5)
        selected_blood_types = SuspectsInfo.get_blood_type(SuspectsInfo.suspect_blood_type_list, 5)
        selected_eye_color = SuspectsInfo.get_eye_color(SuspectsInfo.suspect_eye_color_list, 5)
        selected_ethnicity = SuspectsInfo.get_suspect_ethnicity(SuspectsInfo.suspect_ethnicity_list, 5)
        selected_skin_color = SuspectsInfo.get_skin_color(selected_ethnicity, SuspectsInfo.suspect_skin_color_dict, 5)
        
        SuspectsInfo.generate_suspect_values(suspect_names, selected_hair_colors, selected_height_types, selected_blood_types, selected_eye_color, selected_ethnicity, selected_skin_color)
        ...
        SuspectsInfo.generate_suspect_report(5, suspect_names, pulled_hair_colors, pulled_height_types, pulled_blood_types, pulled_eye_colors, pulled_ethnicity, pulled_skin_color)